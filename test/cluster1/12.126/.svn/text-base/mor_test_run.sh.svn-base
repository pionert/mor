...
#       v3.4    2012-10-31      Speedup fresh db for 12.126 and 12 
#	v3.3	2012-09-06	Leave Asterisk alive
#       v3.2    2012-09-05      Kill unecessary services, debug option for SLOW starting selenium.jar file 
...
house_cleaning()
{
    ...
    # fix random generator to avoid lag between tests
	...
	then
		...
		[ $dbg == 1 ] && echo "Last author: $LAST_AUTHOR";
            ...
            if [ "$CURRENT_REVISION" != "$LAST_REVISION" ] || [ "$MODE" == "0" ]; then
                ...
                echo "House cleaning...."
                # turn off swap, kill some nasty things...
                house_cleaning &
