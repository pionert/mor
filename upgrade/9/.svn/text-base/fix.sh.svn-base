...
report "Adding symlinks to /usr/src/mor/upgrade/9/gui_upgrade_light.sh and /usr/src/mor/upgrade/9/gui_upgrade.sh" 3
ln -s /usr/src/mor/upgrade/9/gui_upgrade_light.sh /home/mor/gui_upgrade_light.sh
ln -s /usr/src/mor/upgrade/9/gui_upgrade.sh /home/mor/gui_upgrade.sh
...
cp -fr /usr/src/mor/asterisk-conf/extensions_mor_anipin.conf /etc/asterisk/

# all other files
cp -fr /usr/src/mor/asterisk-conf/9/extensions_mor.conf /etc/asterisk/
cp -fr /usr/src/mor/asterisk-conf/9/extensions_mor_ad.conf /etc/asterisk/
cp -fr /usr/src/mor/asterisk-conf/9/extensions_mor_callingcard.conf /etc/asterisk/
...
# cronjobs
cp -fr /usr/src/mor/upgrade/9/cronjobs/mor_daily_actions /etc/cron.d/

# do not upgrade gui everyday
