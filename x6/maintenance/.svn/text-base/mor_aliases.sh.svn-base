...
alias minf='/usr/src/mor/x6/info.sh'; 
...
alias cdtest="cd /usr/src/mor/x6/test_fix_scripts"
...
alias genpas='. /usr/src/mor/x6/framework/bash_functions.sh; generate_random_password 12; echo $GENERATED_PASSWD'
