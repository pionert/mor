...
#======= Main ====================
   #clear;
   report "INSTALLING G723 and G729 CODECS........." 3
   cd /usr/src
   rm -rf codec_*
   ...
   if [ -n "$_IS_AMD" ];
      then 
         ...
         cat /proc/cpuinfo
         uname -a
         echo "you can find codecs installation scripts in $SCRIPTS_DIR/asterisk folder";
   fi;
  ...
  report "G723 and G729 Codecs installed" 0
