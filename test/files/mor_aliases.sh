...
alias minf='/usr/src/mor/test/info.sh'; 
...
alias cdtest="cd /usr/src/mor/test/scripts"    
...
alias genpas='. /usr/src/mor/test/framework/bash_functions.sh; generate_random_password 12; echo $GENERATED_PASSWD'
