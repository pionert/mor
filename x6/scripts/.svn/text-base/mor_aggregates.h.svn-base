...
typedef struct calls_data_struct {
    ...
    int did_id;
    double did_price;
    double did_price_with_tax;
    double did_inc_price;
    double did_inc_price_with_tax;
    long int did_billsec;
    long int user_billsec;
    double user_price;
    double user_price_with_tax;
    long int reseller_billsec;
    double reseller_price;
    double reseller_price_with_tax;
    long int partner_billsec;
    double partner_price;
    double partner_price_with_tax;
    int terminator_id;
    int direction_id;
